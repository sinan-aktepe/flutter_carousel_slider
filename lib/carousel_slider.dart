...
class CarouselSliderState extends State<CarouselSlider> with TickerProviderStateMixin {
  ...
  _handleRefreshEvent() {
    Timer(const Duration(milliseconds: 500), () {
      if (carouselState!.pageController!.hasClients && widget.isRefresh!) {
        carouselState!.pageController!.animateToPage(0, duration: Duration(milliseconds: 200), curve: Curves.ease);
      }
    });
  }
